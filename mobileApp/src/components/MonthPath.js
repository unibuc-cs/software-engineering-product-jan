...
const getSeasonBackground = (month) => {
	switch (month) {
		...
		case 1:
		case 2:
			return require("../../assets/vinter.png"); // Update with correct path
		case 3:
		case 4:
		case 5:
			...
			{isVisible && (
				<>
					<View style={styles.backgroundContainer}>
						{Array.from({
							length: Math.ceil((days * verticalSpacing) / 800)
						}).map((_, i) => (
							<Image
								key={i}
						...
						return (
							...
							>
								...
								<View
									style={[
										styles.shadow,
										isHighlighted && styles.highlightedShadow
									]}
								></View>
								<View
									style={[
