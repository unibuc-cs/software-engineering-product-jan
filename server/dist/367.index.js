...
/* harmony export */ });
/* unused harmony exports FileData, client, duplicate, handle_file, predict, prepare_files, submit, upload, upload_files */
...
async function process_single_command(client2, data, key) {
  ...
  try {
    ...
    if (typeof process !== "undefined" && process.versions && process.versions.node) {
      const fs = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 91943, 19));
      const path = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 16928, 19));
...
class Client {
  ...
  async init() {
    ...
    if ((typeof window === "undefined" || !("WebSocket" in window)) && !global.WebSocket) {
      const ws = await __webpack_require__.e(/* import() */ 121).then(__webpack_require__.bind(__webpack_require__, 87121));
